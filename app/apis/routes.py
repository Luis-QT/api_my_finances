...
from app.apis.concepts.search_concepts.router import router as search_concepts_router
from app.apis.concepts.store_concept.router import router as store_concept_router
from app.apis.concepts.update_concept.router import router as update_concept_router
from app.apis.concepts.delete_concept.router import router as delete_concept_router
...
def route(app):
    ...
    app.include_router(update_type_operation_router)
